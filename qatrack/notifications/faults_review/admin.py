...
class FaultsReviewNoticeAdminForm(forms.ModelForm):
    """Form for handling validation of ServiceEventReviewNotice creation/editing"""

    class Meta:
        model = models.FaultsReviewNotice
        fields = (
            "notification_type",
            "send_empty",
            "recurrences",
...
class FaultsReviewAdmin(BaseQATrackAdmin):
    ...
    form = FaultsReviewNoticeAdminForm
...
admin.site.register([models.FaultsReviewNotice], FaultsReviewAdmin)
