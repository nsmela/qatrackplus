...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestListCycle.drop_down_label'
        db.add_column('qa_testlistcycle', 'drop_down_label',
                      self.gf('django.db.models.fields.CharField')(default='Choose Day', max_length=128),
                      keep_default=False)

        # Adding field 'TestListCycle.day_option_text'
        db.add_column('qa_testlistcycle', 'day_option_text',
                      self.gf('django.db.models.fields.CharField')(default='day', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestListCycle.drop_down_label'
        db.delete_column('qa_testlistcycle', 'drop_down_label')

        # Deleting field 'TestListCycle.day_option_text'
        db.delete_column('qa_testlistcycle', 'day_option_text')
    ...
    models = {
        ...
        'qa.testlistcycle': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'drop_down_label': ('django.db.models.fields.CharField', [], {'default': "'Day'", 'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
