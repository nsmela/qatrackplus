...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        if TestInstance.objects.filter(test_list_instance=None):
            raise SouthError("You have TestInstance's with null test_list_instance. Please resolve before migrating")
